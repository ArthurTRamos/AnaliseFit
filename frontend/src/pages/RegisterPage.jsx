import { Activity, Mail, Lock, Eye, User } from "lucide-react";
import { useState } from "react";
import { useNavigate } from "react-router-dom";

function RegisterPage() {
    // A lógica de estados (nome, email, senha) e a função de submit entrarão aqui
        ...
        <div className="min-h-screen flex items-center justify-center bg-slate-50 font-sans">
            <div className="w-full max-w-105 bg-white p-8 rounded-[20px] shadow-[0_4px_24px_rgba(0,0,0,0.04)] border border-gray-100 my-8">
                ...
                <p className="text-center text-sm text-gray-600 mt-6 font-medium">
                    Já tem uma conta? <a href="#" className="text-[#008A52] hover:underline">Entrar</a>
                </p>
